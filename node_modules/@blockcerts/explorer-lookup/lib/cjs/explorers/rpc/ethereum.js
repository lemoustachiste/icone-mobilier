...
function ethereumRPCParsingFunction({ serviceUrl, transactionId }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resultTransactionByHash = yield (0, request_1.default)({
            url: serviceUrl,
        ...
        const resultBlockByNumber = yield (0, request_1.default)({
            url: serviceUrl,
        ...
        const remoteHash = (0, stripHashPrefix_1.stripHashPrefix)(txData.input, ['0x']); // remove '0x'
        return {
            remoteHash,
            issuingAddress,
            time,
...
exports.ethereumRPCParsingFunction = ethereumRPCParsingFunction;
